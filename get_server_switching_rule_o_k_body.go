...
func (m *GetServerSwitchingRuleOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetServerSwitchingRuleOKBody) validateData(formats strfmt.Registry) error {
...
func (m *GetServerSwitchingRuleOKBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetServerSwitchingRuleOKBody) UnmarshalBinary(b []byte) error {
