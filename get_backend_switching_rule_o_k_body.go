...
func (m *GetBackendSwitchingRuleOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetBackendSwitchingRuleOKBody) validateData(formats strfmt.Registry) error {
...
func (m *GetBackendSwitchingRuleOKBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetBackendSwitchingRuleOKBody) UnmarshalBinary(b []byte) error {
