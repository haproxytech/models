...
type ProcessInfo struct {
	...
	// info
	Info *ProcessInfosItems0Info `json:"info,omitempty"`
...
// ProcessInfosItems0Info process infos items0 info
// swagger:model ProcessInfosItems0Info
type ProcessInfosItems0Info struct {
...
// Validate validates this process infos items0 info
func (m *ProcessInfosItems0Info) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ProcessInfosItems0Info) validateReleaseDate(formats strfmt.Registry) error {

	if swag.IsZero(m.ReleaseDate) { // not required
		return nil
	}

	if err := validate.FormatOf("info"+"."+"release_date", "body", "date", m.ReleaseDate.String(), formats); err != nil {
		return err
	}
...
// MarshalBinary interface implementation
func (m *ProcessInfosItems0Info) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ProcessInfosItems0Info) UnmarshalBinary(b []byte) error {
	var res ProcessInfosItems0Info
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
